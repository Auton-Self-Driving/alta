...
class BaseObservationConfig(BaseConfig):
    def __init__(self):
        ...
        # Number of subsequent wps used to compute next wp orientation
        # Also represents the # wps fed as input to certain obs spaces
        ...
        self.semantic = None # TODO remove as sensor dict should be enough
