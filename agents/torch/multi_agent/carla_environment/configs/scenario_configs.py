...
class BaseScenarioConfig(BaseConfig):
    def __init__(self):
        ...
        # Reset all npc if episode length exceeds this limit
        self.npc_reset_freq = None
...
class NoCrashDenseTown01ConfigCustom(NoCrashConfig):
    def __init__(self):
        super().__init__()
        self.scenarios = "no_crash_dense"
        self.num_npc = 0
        self.sample_npc = True
        self.num_npc_lower_threshold = 20
        self.num_npc_upper_threshold = 380
        self.city_name = "Town01"
...
class LeaderboardConfig(BaseScenarioConfig):
    def __init__(self):
        ...
        self.city_name = 'Town06' # No Town5 for LdB
        self.avail_town_list = ['Town01', 'Town02', 'Town03', 'Town04', 'Town06', 'Town07']
        self.vehicle_type = 'vehicle.toyota.prius'
