...
EXPERIMENT_DIR = '/home/brian/temp/factored_dense/2021-04-19_15-01-49/'
CHECKPOINT = 'epoch=6-step=6999.ckpt'
...
def main(cfg):
    ...
    cfg.environment['verbose'] = 1

    reward_list = []
    status_list = []

    env = CarlaEnv(log_dir=os.getcwd(), server_port=53248, **cfg.environment)
