...
def parse_arguments():
    ...
    parser.add_argument('--vae_model_path',dest='vae_model_path',type=str, default='/zfsauton2/home/mayankgu/alta/agents/tf/trained_models/ae_16_32_64_16_fs_1', help='VAE Model path.')
