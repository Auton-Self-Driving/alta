...
from agents.torch.A3C.a3c_env_config import ENV_CONFIG, DISCRETE_ACTIONS, EPISODE_MEASUREMENTS
import scipy.misc
...
class CarlaEnv(gym.Env):
    def __init__(self, config=ENV_CONFIG, vis_wrapper=None, vis_wrapper_vae=None, logger=None, log_dir=None):
