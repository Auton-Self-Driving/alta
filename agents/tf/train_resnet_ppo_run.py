...
import inspect
print([f[0] for f in inspect.getmembers(vis_module, inspect.isfunction)])
# PPO specific
    ...
    for i in range(MAX_TRIALS):
        try:
            ...
            if args.test:
                ...
                IMAGES_PATH_VAE = SCRATCH_DIR+'resnet_images/'
                VIDEO_PATH_VAE = SCRATCH_DIR+'resnet_videos/'
                ...
                resnet = get_resnet(model_path)
                env.set_resnet(resnet)
