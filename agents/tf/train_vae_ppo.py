...
from ppo import PPO
from models import CustomPolicy, CustomWPPolicy

vae = AEController()
# change
prefix = 'test2/'

PATH_MODEL_VAE = "vae-model-60000.json"
ALTA_LOGS = '/zfsauton2/home/tanmaya/projects/alta-logs/new_ppo_wp_vae_scenarios_straight/' + prefix
    ...
    for i in range(MAX_TRIALS):
        try:
            ...
            if os.path.exists(SAVE_PATH + ".pkl"):
                ...
                model = PPO(policy=CustomPolicy, env=dummy_env, n_steps=500, nminibatches=4, verbose=1, learning_rate=8e-5,
